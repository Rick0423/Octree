...
VL_ATTR_COLD void VOctree_tb___024root___dump_triggers__act(VOctree_tb___024root* vlSelf) {
    ...
    if ((8ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 3 is active: @( Octree_tb.out_ready)\n");
    }
...
VL_ATTR_COLD void VOctree_tb___024root___dump_triggers__nba(VOctree_tb___024root* vlSelf) {
    ...
    if ((8ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 3 is active: @( Octree_tb.out_ready)\n");
    }
...
VL_ATTR_COLD void VOctree_tb___024root___ctor_var_reset(VOctree_tb___024root* vlSelf) {
    ...
    vlSelf->Octree_tb__DOT__out_ready = VL_RAND_RESET_I(1);
    ...
    vlSelf->Octree_tb__DOT__u_Octree__DOT__searcher_sram_CEN = VL_RAND_RESET_I(1);
    vlSelf->Octree_tb__DOT__u_Octree__DOT__searcher_sram_D = VL_RAND_RESET_Q(64);
    ...
    vlSelf->Octree_tb__DOT__u_Octree__DOT__searcher_inst__DOT__search_sram_CEN = VL_RAND_RESET_I(1);
    vlSelf->Octree_tb__DOT__u_Octree__DOT__searcher_inst__DOT__search_sram_D = VL_RAND_RESET_Q(64);
    vlSelf->Octree_tb__DOT__u_Octree__DOT__searcher_inst__DOT__search_sram_GWEN = VL_RAND_RESET_I(1);
    ...
    vlSelf->Octree_tb__DOT__u_Octree__DOT__searcher_inst__DOT__tree_search_done = VL_RAND_RESET_I(1);
    ...
    vlSelf->Octree_tb__DOT__u_Octree__DOT__searcher_inst__DOT__u_lod_compute__DOT__oct_pos = VL_RAND_RESET_Q(48);
    ...
    vlSelf->__Vtrigprevexpr___TOP__Octree_tb__DOT__out_ready__0 = VL_RAND_RESET_I(1);
