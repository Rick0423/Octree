...
void VOctree_tb___024root___eval_triggers__act(VOctree_tb___024root* vlSelf) {
    ...
    vlSelfRef.__VactTriggered.set(3U, ((IData)(vlSelfRef.Octree_tb__DOT__u_Octree__DOT__searcher_inst__DOT__u_tree_search__DOT__out_ready) 
                                       != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__Octree_tb__DOT__u_Octree__DOT__searcher_inst__DOT__u_tree_search__DOT__out_ready__0)));
